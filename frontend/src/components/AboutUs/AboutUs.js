          ...
          <>
            ...
            <div className="AboutUsSection1">
                <div className="AboutUsSection1-text">
                    <p className="AboutUsSection1-text-heading">About Us</p>
                    <p className="AboutUsSection1-text-para1">At Gollaa we believe that this is the time we
                     have to create a new socio-economic paradigm that responds to our current situation as
                      well as creates an equilibrium between humanity and nature. The gollaa (Circle or 360°)
                       is an universal symbol with extensive meaning, it represents the notions of totality,
                        wholeness, original perfection, the self, the infinite, eternity, timelessness, 
                        all cyclic movements, God (‘God is a circle whose centre is everywhere and whose 
                        circumference is nowhere’) <span>“Hermes Trismegistus"</span>. Golla implies an idea 
                        of the movement and symbolizes the cycle of time, the perpetual motion of everything 
                        that moves. The circle is also “Zero” in our numbering system and symbolizes potential,
                        or the embryo. It has a magical value as a protective agent and indicates the end of the
                         process of <span>individuation and a move towards oneness.</span> Gollaa is a blockchain backed marketplace for local producers and consumers to interact and participate in local economy; furthermore, this technology will not only help consumers to track quality, origin and nature of their products, as well as, it will help farmers and local businesses 
